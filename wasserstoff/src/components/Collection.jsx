...
export default function Collection() {
    return (
        <div className="h-screen bg-[#15181B]">
            ...
            <div class="flex">
                <div class="flex-none w-[60%]  h-screen bg-[#15181B]">
                    <div className='flex p-5'>
                        <div><img src={branding} alt="" /></div>
                ...
                <div class="grow w-h-screen bg-[#15181B]">
                    <img src={roll} alt="" className=' h-screen' />
                </div>
                <div class="flex-none w-[35%] h-screen bg-[#15181B]">
                    <div className='p-10'>
                        ...
                        <div className='flex gap-5 my-3'>
                            <div class="w-2/5 flex flex-col items-center    rounded-xl p-2 bg-[#B9A0FF]">
                                ...
                                <p class=" mt-0  text-xs text-black font-bold p-0">Collectible Name</p>
                                <a href=""> <img src={card} alt class="rounded-xl" /> </a>
